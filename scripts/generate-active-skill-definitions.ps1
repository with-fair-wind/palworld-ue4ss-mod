...
$lines.Add(" * @brief Generated Palworld active-skill values and Raw IDs from the current")
$lines.Add(" *        EPalWazaID dump.")
...
$lines.Add(" * @note Regenerate after any Palworld update that ships a new EPalWazaID enum.")
$lines.Add(" */")
