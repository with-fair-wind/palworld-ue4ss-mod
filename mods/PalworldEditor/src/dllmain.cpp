...
public:
    ...
    PalworldEditorMod() : CppUserModBase() {
        ...
        register_tab(STR("PalworldEditor"), [](CppUserModBase* mod) {
            ...
            if (ImGui::Begin("PalworldEditor v1.5.2", nullptr, ImGuiWindowFlags_AlwaysAutoResize)) {
