...
public:
    ...
    PalworldEditorMod() : CppUserModBase() {
        ...
        register_tab(STR("PalworldEditor"), [](CppUserModBase* mod) {
            ...
            if (ImGui::Begin("PalworldEditor v1.6.3", nullptr, ImGuiWindowFlags_AlwaysAutoResize)) {
