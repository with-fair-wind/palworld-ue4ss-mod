...
> **历史方案，已废弃：** 本文提出的 `PalDebugSetting` 路径未进入最终实现。权威方案见
> `docs/superpowers/specs/2026-07-28-feature-safety-integration-design.md` 和
> `docs/superpowers/plans/2026-07-28-feature-safety-integration.md`。
